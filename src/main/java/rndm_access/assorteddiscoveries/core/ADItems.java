...
public class ADItems {
    ...
    public static void registerItems() {
        ...
        registerItem("quartz_wall", QUARTZ_WALL);
        registerItem("smooth_quartz_wall", SMOOTH_QUARTZ_WALL);
        registerItem("stone_wall", STONE_WALL);
        ...
        registerItem("tuff_bricks", TUFF_BRICKS);
        registerItem("tuff_brick_stairs", TUFF_BRICK_STAIRS);
        registerItem("tuff_brick_slab", TUFF_BRICK_SLAB);
        registerItem("tuff_brick_wall", TUFF_BRICK_WALL);
        registerItem("mossy_tuff_bricks", MOSSY_TUFF_BRICKS);
        registerItem("mossy_tuff_brick_stairs", MOSSY_TUFF_BRICK_STAIRS);
        registerItem("mossy_tuff_brick_slab", MOSSY_TUFF_BRICK_SLAB);
        registerItem("mossy_tuff_brick_wall", MOSSY_TUFF_BRICK_WALL);
        registerItem("cracked_tuff_bricks", CRACKED_TUFF_BRICKS);
        registerItem("cracked_tuff_brick_stairs", CRACKED_TUFF_BRICK_STAIRS);
        registerItem("cracked_tuff_brick_slab", CRACKED_TUFF_BRICK_SLAB);
        registerItem("cracked_tuff_brick_wall", CRACKED_TUFF_BRICK_WALL);
        registerItem("chiseled_tuff_bricks", CHISELED_TUFF_BRICKS);
